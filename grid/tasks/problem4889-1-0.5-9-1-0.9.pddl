(define (problem grid-3-4-9-10-10)
    (:domain grid)
    (:objects
    ...
    (:init
       ...
       (lock-shape  pos1-3 shape4)
       (lock-shape  pos1-0 shape5)
       (lock-shape  pos1-1 shape6)
       (lock-shape  pos0-2 shape7)
       (lock-shape  pos0-1 shape8)
       (lock-shape  pos1-2 shape4)
       (open pos2-0)
       (open pos2-1)
