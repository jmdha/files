; 13 floors, area size: 3, areas: 4, passengers: 17
...
(:domain elevators-sequencedstrips)
    ...
    (:init
       ...
       (reachable-floor fast1 n0) (reachable-floor fast1 n1) (reachable-floor fast1 n2) (reachable-floor fast1 n3) (reachable-floor fast1 n4) (reachable-floor fast1 n5) (reachable-floor fast1 n6) (reachable-floor fast1 n7) (reachable-floor fast1 n8) (reachable-floor fast1 n9) (reachable-floor fast1 n10) (reachable-floor fast1 n11) (reachable-floor fast1 n12)
    
       (lift-at fast2 n7)
       (passengers fast2 n0)
       (can-hold fast2 n1) (can-hold fast2 n2) (can-hold fast2 n3)
       (reachable-floor fast2 n0) (reachable-floor fast2 n1) (reachable-floor fast2 n2) (reachable-floor fast2 n3) (reachable-floor fast2 n4) (reachable-floor fast2 n5) (reachable-floor fast2 n6) (reachable-floor fast2 n7) (reachable-floor fast2 n8) (reachable-floor fast2 n9) (reachable-floor fast2 n10) (reachable-floor fast2 n11) (reachable-floor fast2 n12)
       ...
       (reachable-floor slow3-0 n9) (reachable-floor slow3-0 n10) (reachable-floor slow3-0 n11) (reachable-floor slow3-0 n12)
       ...
       (= (travel-fast n1 n10) 28)
       (= (travel-fast n1 n11) 31)
       (= (travel-fast n1 n12) 34)
       (= (travel-fast n2 n3) 4)
       (= (travel-fast n2 n4) 7)
       ...
       (= (travel-fast n3 n10) 22)
       (= (travel-fast n3 n11) 25)
       ...
       (= (travel-fast n5 n11) 19)
       (= (travel-fast n5 n12) 22)
       (= (travel-fast n6 n7) 4)
       (= (travel-fast n6 n8) 7)
       (= (travel-fast n6 n9) 10)
       (= (travel-fast n6 n10) 13)
       (= (travel-fast n6 n11) 16)
       (= (travel-fast n6 n12) 19)
       (= (travel-fast n7 n8) 4)
       (= (travel-fast n7 n9) 7)
       (= (travel-fast n7 n10) 10)
       (= (travel-fast n7 n11) 13)
       (= (travel-fast n7 n12) 16)
       (= (travel-fast n8 n9) 4)
       (= (travel-fast n8 n10) 7)
       (= (travel-fast n8 n11) 10)
       (= (travel-fast n8 n12) 13)
       (= (travel-fast n9 n10) 4)
       (= (travel-fast n9 n11) 7)
       (= (travel-fast n9 n12) 10)
       (= (travel-fast n10 n11) 4)
       (= (travel-fast n10 n12) 7)
       (= (travel-fast n11 n12) 4)
