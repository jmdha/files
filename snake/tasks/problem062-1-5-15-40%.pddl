(define (problem snake-empty-7x7-1-5-11-62)
(:domain snake)
(:objects
...
(:init
 ...
 (isAdjacent pos6-6 pos6-5)
    (tailSnake pos2-0)
    (headSnake pos3-0)
    (nextSnake pos3-0 pos2-0)
    (blocked pos2-0)
 (blocked pos3-0)
    (spawn pos1-2)
 (nextSpawn pos6-0 dummyPoint)
 (nextSpawn pos1-2 pos1-1)
 (nextSpawn pos1-1 pos4-4)
 (nextSpawn pos4-4 pos2-3)
 (nextSpawn pos2-3 pos5-1)
 (nextSpawn pos5-1 pos3-3)
 (nextSpawn pos3-3 pos1-0)
 (nextSpawn pos1-0 pos5-4)
 (nextSpawn pos5-4 pos6-3)
 (nextSpawn pos6-3 pos1-3)
 (nextSpawn pos1-3 pos6-0)
    (isPoint pos5-0)
 (isPoint pos0-4)
 (isPoint pos5-5)
 (isPoint pos2-5)
