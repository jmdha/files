(define (problem transport-l16-t1-p2---int100n150-m25---int100c200---s301---e0)
...
(connected l5 l13)
(fuelcost level9 l5 l13)
(connected l6 l1)
(fuelcost level22 l6 l1)
(connected l6 l5)
(fuelcost level3 l6 l5)
(connected l7 l11)
(fuelcost level22 l7 l11)
(connected l7 l14)
