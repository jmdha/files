(define (problem transport-l13-t1-p4---int100n150-m25---int100c150---s235---e0)
...
(connected l9 l10)
(fuelcost level8 l9 l10)
(connected l10 l5)
(fuelcost level9 l10 l5)
(connected l10 l9)
(fuelcost level8 l10 l9)
(connected l10 l11)
