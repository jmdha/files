(define (problem transport-l14-t1-p4---int100n150-m25---int100c150---s316---e0)
...
(connected l2 l13)
(fuelcost level20 l2 l13)
(connected l3 l12)
(fuelcost level4 l3 l12)
(connected l4 l1)
(fuelcost level2 l4 l1)
(connected l4 l13)
(fuelcost level13 l4 l13)
(connected l5 l0)
...
(connected l13 l2)
(fuelcost level20 l13 l2)
(connected l13 l4)
(fuelcost level13 l13 l4)
(connected l13 l6)
