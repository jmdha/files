(define (problem transport-l16-t1-p2---int100n150-m25---int100c110---s257---e0)
...
(connected l6 l14)
(fuelcost level19 l6 l14)
(connected l7 l4)
(fuelcost level24 l7 l4)
(connected l7 l6)
(fuelcost level18 l7 l6)
(connected l7 l13)
(fuelcost level2 l7 l13)
(connected l8 l6)
...
(connected l13 l7)
(fuelcost level2 l13 l7)
(connected l13 l15)
(fuelcost level11 l13 l15)
(connected l14 l6)
(fuelcost level19 l14 l6)
(connected l14 l10)
(fuelcost level22 l14 l10)
(connected l14 l15)
(fuelcost level15 l14 l15)
(connected l15 l0)
(fuelcost level2 l15 l0)
(connected l15 l12)
(fuelcost level15 l15 l12)
(connected l15 l13)
(fuelcost level11 l15 l13)
(connected l15 l14)
(fuelcost level15 l15 l14)
