(define (problem scanalyzer3d-4-ab-in)
  (:domain scanalyzer3d)
  (:objects
    car-in-1a - car
    car-in-1b - car
  ...
  (:init
    ...
    (CYCLE-4-WITH-ANALYSIS seg-in-4a seg-in-4b seg-out-1a seg-out-1b)
