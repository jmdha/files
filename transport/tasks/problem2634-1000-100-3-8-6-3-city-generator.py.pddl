; Transport city-sequential-3nodes-1000size-3degree-100mindistance-6trucks-8packages-2634seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-6trucks-8packages-2634seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
