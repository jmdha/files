; Transport city-sequential-4nodes-1000size-4degree-100mindistance-8trucks-2packages-1243seed

(define (problem transport-city-sequential-4nodes-1000size-4degree-100mindistance-8trucks-2packages-1243seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
