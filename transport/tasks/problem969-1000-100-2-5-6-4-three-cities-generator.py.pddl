; Transport three-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-5packages-969seed

(define (problem transport-three-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-5packages-969seed)
 (:domain transport)
 (:objects
