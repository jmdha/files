; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-6trucks-7packages-2294seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-6trucks-7packages-2294seed)
 (:domain transport)
 (:objects
