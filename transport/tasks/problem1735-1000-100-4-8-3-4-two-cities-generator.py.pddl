; Transport two-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-8packages-1735seed

(define (problem transport-two-cities-sequential-4nodes-1000size-4degree-100mindistance-3trucks-8packages-1735seed)
 (:domain transport)
 (:objects
