; Transport two-cities-sequential-5nodes-1000size-3degree-100mindistance-7trucks-7packages-4261seed

(define (problem transport-two-cities-sequential-5nodes-1000size-3degree-100mindistance-7trucks-7packages-4261seed)
 (:domain transport)
 (:objects
