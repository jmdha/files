; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-10packages-1587seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-10packages-1587seed)
 (:domain transport)
 (:objects
