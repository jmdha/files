; Transport two-cities-sequential-6nodes-1000size-3degree-100mindistance-4trucks-8packages-3406seed

(define (problem transport-two-cities-sequential-6nodes-1000size-3degree-100mindistance-4trucks-8packages-3406seed)
 (:domain transport)
 (:objects
