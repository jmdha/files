; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-5trucks-8packages-2491seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-5trucks-8packages-2491seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-3 city-1-loc-1) 81)
  ; 673,177 -> 972,924
  (road city-1-loc-1 city-1-loc-3)
  (= (road-length city-1-loc-1 city-1-loc-3) 81)
  ; 972,924 -> 829,640
