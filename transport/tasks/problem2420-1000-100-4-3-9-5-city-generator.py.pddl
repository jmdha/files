; Transport city-sequential-4nodes-1000size-5degree-100mindistance-9trucks-3packages-2420seed

(define (problem transport-city-sequential-4nodes-1000size-5degree-100mindistance-9trucks-3packages-2420seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
