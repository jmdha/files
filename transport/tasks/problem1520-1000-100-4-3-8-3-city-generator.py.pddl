; Transport city-sequential-4nodes-1000size-3degree-100mindistance-8trucks-3packages-1520seed

(define (problem transport-city-sequential-4nodes-1000size-3degree-100mindistance-8trucks-3packages-1520seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
