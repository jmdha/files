; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-7trucks-8packages-2958seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-7trucks-8packages-2958seed)
 (:domain transport)
 (:objects
