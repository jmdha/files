; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-8trucks-7packages-3440seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-8trucks-7packages-3440seed)
 (:domain transport)
 (:objects
