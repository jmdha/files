; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-8packages-3192seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-8packages-3192seed)
 (:domain transport)
 (:objects
