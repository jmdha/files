; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-6packages-2306seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-6packages-2306seed)
 (:domain transport)
 (:objects
