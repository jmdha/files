; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-7trucks-7packages-2713seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-7trucks-7packages-2713seed)
 (:domain transport)
 (:objects
