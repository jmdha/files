; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-10packages-2956seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-10packages-2956seed)
 (:domain transport)
 (:objects
