; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-4packages-1168seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-4packages-1168seed)
 (:domain transport)
 (:objects
