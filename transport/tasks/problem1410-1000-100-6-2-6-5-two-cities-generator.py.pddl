; Transport two-cities-sequential-6nodes-1000size-5degree-100mindistance-6trucks-2packages-1410seed

(define (problem transport-two-cities-sequential-6nodes-1000size-5degree-100mindistance-6trucks-2packages-1410seed)
 (:domain transport)
 (:objects
