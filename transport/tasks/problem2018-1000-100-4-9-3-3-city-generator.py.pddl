; Transport city-sequential-4nodes-1000size-3degree-100mindistance-3trucks-9packages-2018seed

(define (problem transport-city-sequential-4nodes-1000size-3degree-100mindistance-3trucks-9packages-2018seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
