; Transport two-cities-sequential-7nodes-1000size-4degree-100mindistance-5trucks-3packages-1719seed

(define (problem transport-two-cities-sequential-7nodes-1000size-4degree-100mindistance-5trucks-3packages-1719seed)
 (:domain transport)
 (:objects
