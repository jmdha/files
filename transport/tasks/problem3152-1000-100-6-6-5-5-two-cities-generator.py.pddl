; Transport two-cities-sequential-6nodes-1000size-5degree-100mindistance-5trucks-6packages-3152seed

(define (problem transport-two-cities-sequential-6nodes-1000size-5degree-100mindistance-5trucks-6packages-3152seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-5 city-2-loc-2) 142)
  (road city-2-loc-2 city-1-loc-5)
  (= (road-length city-2-loc-2 city-1-loc-5) 142)
