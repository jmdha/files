; Transport city-sequential-5nodes-1000size-4degree-100mindistance-4trucks-9packages-3597seed

(define (problem transport-city-sequential-5nodes-1000size-4degree-100mindistance-4trucks-9packages-3597seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
