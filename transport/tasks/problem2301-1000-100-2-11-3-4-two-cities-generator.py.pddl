; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-3trucks-11packages-2301seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-3trucks-11packages-2301seed)
 (:domain transport)
 (:objects
