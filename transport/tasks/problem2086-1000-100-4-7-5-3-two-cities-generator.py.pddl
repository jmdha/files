; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-5trucks-7packages-2086seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-5trucks-7packages-2086seed)
 (:domain transport)
 (:objects
