; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-5trucks-7packages-1165seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-5trucks-7packages-1165seed)
 (:domain transport)
 (:objects
