; Transport city-sequential-3nodes-1000size-3degree-100mindistance-7trucks-6packages-2031seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-7trucks-6packages-2031seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
