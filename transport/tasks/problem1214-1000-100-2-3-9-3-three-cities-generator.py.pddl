; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-3packages-1214seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-3packages-1214seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-2-loc-1) 213)
  (road city-2-loc-1 city-1-loc-1)
  (= (road-length city-2-loc-1 city-1-loc-1) 213)
  (road city-1-loc-1 city-3-loc-2)
  (= (road-length city-1-loc-1 city-3-loc-2) 218)
  (road city-3-loc-2 city-1-loc-1)
  (= (road-length city-3-loc-2 city-1-loc-1) 218)
  (road city-2-loc-2 city-3-loc-2)
  (= (road-length city-2-loc-2 city-3-loc-2) 234)
  (road city-3-loc-2 city-2-loc-2)
  (= (road-length city-3-loc-2 city-2-loc-2) 234)
