; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-4packages-1574seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-4packages-1574seed)
 (:domain transport)
 (:objects
