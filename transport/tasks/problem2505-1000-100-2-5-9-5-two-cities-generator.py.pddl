; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-5packages-2505seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-5packages-2505seed)
 (:domain transport)
 (:objects
