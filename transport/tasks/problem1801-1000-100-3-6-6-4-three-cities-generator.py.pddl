; Transport three-cities-sequential-3nodes-1000size-4degree-100mindistance-6trucks-6packages-1801seed

(define (problem transport-three-cities-sequential-3nodes-1000size-4degree-100mindistance-6trucks-6packages-1801seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-3-loc-1) 197)
  (road city-3-loc-1 city-1-loc-1)
  (= (road-length city-3-loc-1 city-1-loc-1) 197)
  (road city-2-loc-2 city-3-loc-1)
  (= (road-length city-2-loc-2 city-3-loc-1) 190)
  (road city-3-loc-1 city-2-loc-2)
  (= (road-length city-3-loc-1 city-2-loc-2) 190)
