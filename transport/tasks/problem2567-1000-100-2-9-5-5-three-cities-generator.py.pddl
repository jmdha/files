; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-5trucks-9packages-2567seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-5trucks-9packages-2567seed)
 (:domain transport)
 (:objects
