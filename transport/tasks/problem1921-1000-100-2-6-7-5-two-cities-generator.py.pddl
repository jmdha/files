; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-6packages-1921seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-6packages-1921seed)
 (:domain transport)
 (:objects
