; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-9trucks-4packages-2705seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-9trucks-4packages-2705seed)
 (:domain transport)
 (:objects
