; Transport city-sequential-3nodes-1000size-3degree-100mindistance-8trucks-3packages-1115seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-8trucks-3packages-1115seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
