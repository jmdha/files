; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-9packages-4298seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-9packages-4298seed)
 (:domain transport)
 (:objects
