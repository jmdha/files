; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-8packages-4299seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-8packages-4299seed)
 (:domain transport)
 (:objects
