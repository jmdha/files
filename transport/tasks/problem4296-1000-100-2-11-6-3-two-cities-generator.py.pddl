; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-11packages-4296seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-11packages-4296seed)
 (:domain transport)
 (:objects
