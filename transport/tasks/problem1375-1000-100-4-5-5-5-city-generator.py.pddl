; Transport city-sequential-4nodes-1000size-5degree-100mindistance-5trucks-5packages-1375seed

(define (problem transport-city-sequential-4nodes-1000size-5degree-100mindistance-5trucks-5packages-1375seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
