; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-8packages-1299seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-8packages-1299seed)
 (:domain transport)
 (:objects
