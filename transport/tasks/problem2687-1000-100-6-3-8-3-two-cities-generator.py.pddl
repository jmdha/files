; Transport two-cities-sequential-6nodes-1000size-3degree-100mindistance-8trucks-3packages-2687seed

(define (problem transport-two-cities-sequential-6nodes-1000size-3degree-100mindistance-8trucks-3packages-2687seed)
 (:domain transport)
 (:objects
