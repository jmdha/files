; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-7packages-1755seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-7packages-1755seed)
 (:domain transport)
 (:objects
