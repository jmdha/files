; Transport city-sequential-3nodes-1000size-4degree-100mindistance-8trucks-6packages-2870seed

(define (problem transport-city-sequential-3nodes-1000size-4degree-100mindistance-8trucks-6packages-2870seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
