; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-7packages-1920seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-7packages-1920seed)
 (:domain transport)
 (:objects
