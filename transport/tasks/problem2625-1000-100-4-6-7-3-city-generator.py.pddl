; Transport city-sequential-4nodes-1000size-3degree-100mindistance-7trucks-6packages-2625seed

(define (problem transport-city-sequential-4nodes-1000size-3degree-100mindistance-7trucks-6packages-2625seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
