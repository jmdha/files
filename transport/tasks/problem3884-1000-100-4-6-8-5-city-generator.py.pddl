; Transport city-sequential-4nodes-1000size-5degree-100mindistance-8trucks-6packages-3884seed

(define (problem transport-city-sequential-4nodes-1000size-5degree-100mindistance-8trucks-6packages-3884seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
