; Transport two-cities-sequential-4nodes-1000size-4degree-100mindistance-9trucks-5packages-3703seed

(define (problem transport-two-cities-sequential-4nodes-1000size-4degree-100mindistance-9trucks-5packages-3703seed)
 (:domain transport)
 (:objects
