; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-3trucks-8packages-1425seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-3trucks-8packages-1425seed)
 (:domain transport)
 (:objects
