; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-12trucks-2packages-2310seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-12trucks-2packages-2310seed)
 (:domain transport)
 (:objects
