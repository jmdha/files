; Transport three-cities-sequential-3nodes-1000size-5degree-100mindistance-3trucks-8packages-1470seed

(define (problem transport-three-cities-sequential-3nodes-1000size-5degree-100mindistance-3trucks-8packages-1470seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-3 city-3-loc-2) 142)
  (road city-3-loc-2 city-1-loc-3)
  (= (road-length city-3-loc-2 city-1-loc-3) 142)
