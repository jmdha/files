; Transport city-sequential-5nodes-1000size-4degree-100mindistance-3trucks-8packages-2208seed

(define (problem transport-city-sequential-5nodes-1000size-4degree-100mindistance-3trucks-8packages-2208seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
