; Transport two-cities-sequential-4nodes-1000size-4degree-100mindistance-5trucks-5packages-1285seed

(define (problem transport-two-cities-sequential-4nodes-1000size-4degree-100mindistance-5trucks-5packages-1285seed)
 (:domain transport)
 (:objects
