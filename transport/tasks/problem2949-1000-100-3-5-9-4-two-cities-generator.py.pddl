; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-9trucks-5packages-2949seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-9trucks-5packages-2949seed)
 (:domain transport)
 (:objects
