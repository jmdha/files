; Transport two-cities-sequential-4nodes-1000size-4degree-100mindistance-8trucks-2packages-1288seed

(define (problem transport-two-cities-sequential-4nodes-1000size-4degree-100mindistance-8trucks-2packages-1288seed)
 (:domain transport)
 (:objects
