; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-7trucks-5packages-1747seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-7trucks-5packages-1747seed)
 (:domain transport)
 (:objects
