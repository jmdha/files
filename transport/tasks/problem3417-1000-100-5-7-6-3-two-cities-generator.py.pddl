; Transport two-cities-sequential-5nodes-1000size-3degree-100mindistance-6trucks-7packages-3417seed

(define (problem transport-two-cities-sequential-5nodes-1000size-3degree-100mindistance-6trucks-7packages-3417seed)
 (:domain transport)
 (:objects
