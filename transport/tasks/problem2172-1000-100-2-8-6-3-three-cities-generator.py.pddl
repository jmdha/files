; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-8packages-2172seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-8packages-2172seed)
 (:domain transport)
 (:objects
