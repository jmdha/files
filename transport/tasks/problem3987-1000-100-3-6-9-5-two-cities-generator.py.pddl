; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-9trucks-6packages-3987seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-9trucks-6packages-3987seed)
 (:domain transport)
 (:objects
