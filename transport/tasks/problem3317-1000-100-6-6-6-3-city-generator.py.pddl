; Transport city-sequential-6nodes-1000size-3degree-100mindistance-6trucks-6packages-3317seed

(define (problem transport-city-sequential-6nodes-1000size-3degree-100mindistance-6trucks-6packages-3317seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
