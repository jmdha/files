; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-4packages-1923seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-4packages-1923seed)
 (:domain transport)
 (:objects
