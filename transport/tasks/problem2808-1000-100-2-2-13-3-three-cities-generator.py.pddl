; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-13trucks-2packages-2808seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-13trucks-2packages-2808seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-3-loc-2) 198)
  (road city-3-loc-2 city-1-loc-2)
  (= (road-length city-3-loc-2 city-1-loc-2) 198)
  (road city-2-loc-1 city-3-loc-2)
  (= (road-length city-2-loc-1 city-3-loc-2) 188)
  (road city-3-loc-2 city-2-loc-1)
  (= (road-length city-3-loc-2 city-2-loc-1) 188)
