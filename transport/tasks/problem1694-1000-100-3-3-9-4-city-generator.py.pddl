; Transport city-sequential-3nodes-1000size-4degree-100mindistance-9trucks-3packages-1694seed

(define (problem transport-city-sequential-3nodes-1000size-4degree-100mindistance-9trucks-3packages-1694seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
