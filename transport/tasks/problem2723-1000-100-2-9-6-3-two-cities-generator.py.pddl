; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-9packages-2723seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-9packages-2723seed)
 (:domain transport)
 (:objects
