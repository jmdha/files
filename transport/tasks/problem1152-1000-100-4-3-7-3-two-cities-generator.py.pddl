; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-3packages-1152seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-3packages-1152seed)
 (:domain transport)
 (:objects
