; Transport city-sequential-4nodes-1000size-5degree-100mindistance-6trucks-6packages-2417seed

(define (problem transport-city-sequential-4nodes-1000size-5degree-100mindistance-6trucks-6packages-2417seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
