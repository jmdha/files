; Transport two-cities-sequential-6nodes-1000size-4degree-100mindistance-8trucks-2packages-2272seed

(define (problem transport-two-cities-sequential-6nodes-1000size-4degree-100mindistance-8trucks-2packages-2272seed)
 (:domain transport)
 (:objects
