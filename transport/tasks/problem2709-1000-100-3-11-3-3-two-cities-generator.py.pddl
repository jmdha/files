; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-11packages-2709seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-11packages-2709seed)
 (:domain transport)
 (:objects
