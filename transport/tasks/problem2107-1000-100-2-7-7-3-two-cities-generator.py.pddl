; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-7trucks-7packages-2107seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-7trucks-7packages-2107seed)
 (:domain transport)
 (:objects
