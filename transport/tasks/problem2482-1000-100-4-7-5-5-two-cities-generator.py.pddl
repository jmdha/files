; Transport two-cities-sequential-4nodes-1000size-5degree-100mindistance-5trucks-7packages-2482seed

(define (problem transport-two-cities-sequential-4nodes-1000size-5degree-100mindistance-5trucks-7packages-2482seed)
 (:domain transport)
 (:objects
