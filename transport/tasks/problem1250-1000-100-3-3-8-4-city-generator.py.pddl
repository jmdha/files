; Transport city-sequential-3nodes-1000size-4degree-100mindistance-8trucks-3packages-1250seed

(define (problem transport-city-sequential-3nodes-1000size-4degree-100mindistance-8trucks-3packages-1250seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
