; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-9trucks-7packages-3726seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-9trucks-7packages-3726seed)
 (:domain transport)
 (:objects
