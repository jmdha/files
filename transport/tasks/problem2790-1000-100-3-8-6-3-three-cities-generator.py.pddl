; Transport three-cities-sequential-3nodes-1000size-3degree-100mindistance-6trucks-8packages-2790seed

(define (problem transport-three-cities-sequential-3nodes-1000size-3degree-100mindistance-6trucks-8packages-2790seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-2-loc-3) 137)
  (road city-2-loc-3 city-1-loc-2)
  (= (road-length city-2-loc-3 city-1-loc-2) 137)
  (road city-1-loc-1 city-3-loc-3)
  (= (road-length city-1-loc-1 city-3-loc-3) 161)
  (road city-3-loc-3 city-1-loc-1)
  (= (road-length city-3-loc-3 city-1-loc-1) 161)
