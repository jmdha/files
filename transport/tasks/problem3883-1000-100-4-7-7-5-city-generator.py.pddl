; Transport city-sequential-4nodes-1000size-5degree-100mindistance-7trucks-7packages-3883seed

(define (problem transport-city-sequential-4nodes-1000size-5degree-100mindistance-7trucks-7packages-3883seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
