; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-5trucks-6packages-1040seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-5trucks-6packages-1040seed)
 (:domain transport)
 (:objects
