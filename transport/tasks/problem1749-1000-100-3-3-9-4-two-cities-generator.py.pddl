; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-9trucks-3packages-1749seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-9trucks-3packages-1749seed)
 (:domain transport)
 (:objects
