; Transport city-sequential-5nodes-1000size-3degree-100mindistance-4trucks-5packages-1098seed

(define (problem transport-city-sequential-5nodes-1000size-3degree-100mindistance-4trucks-5packages-1098seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
