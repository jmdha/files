; Transport city-sequential-8nodes-1000size-3degree-100mindistance-5trucks-2packages-1495seed

(define (problem transport-city-sequential-8nodes-1000size-3degree-100mindistance-5trucks-2packages-1495seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
