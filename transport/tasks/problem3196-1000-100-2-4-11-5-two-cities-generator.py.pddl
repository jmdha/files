; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-11trucks-4packages-3196seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-11trucks-4packages-3196seed)
 (:domain transport)
 (:objects
