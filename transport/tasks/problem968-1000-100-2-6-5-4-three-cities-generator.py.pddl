; Transport three-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-6packages-968seed

(define (problem transport-three-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-6packages-968seed)
 (:domain transport)
 (:objects
