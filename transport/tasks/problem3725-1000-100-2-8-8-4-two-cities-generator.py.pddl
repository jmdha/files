; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-8packages-3725seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-8packages-3725seed)
 (:domain transport)
 (:objects
