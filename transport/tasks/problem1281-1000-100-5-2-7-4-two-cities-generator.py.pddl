; Transport two-cities-sequential-5nodes-1000size-4degree-100mindistance-7trucks-2packages-1281seed

(define (problem transport-two-cities-sequential-5nodes-1000size-4degree-100mindistance-7trucks-2packages-1281seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-2-loc-5) 134)
  (road city-2-loc-5 city-1-loc-1)
  (= (road-length city-2-loc-5 city-1-loc-1) 134)
