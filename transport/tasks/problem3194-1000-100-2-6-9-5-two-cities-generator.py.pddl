; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-6packages-3194seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-6packages-3194seed)
 (:domain transport)
 (:objects
