; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-11trucks-4packages-2806seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-11trucks-4packages-2806seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-3-loc-2) 170)
  (road city-3-loc-2 city-1-loc-2)
  (= (road-length city-3-loc-2 city-1-loc-2) 170)
  (road city-2-loc-1 city-3-loc-1)
  (= (road-length city-2-loc-1 city-3-loc-1) 249)
  (road city-3-loc-1 city-2-loc-1)
  (= (road-length city-3-loc-1 city-2-loc-1) 249)
