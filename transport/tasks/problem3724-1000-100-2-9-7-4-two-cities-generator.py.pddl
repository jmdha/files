; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-7trucks-9packages-3724seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-7trucks-9packages-3724seed)
 (:domain transport)
 (:objects
