; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-8packages-1164seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-8packages-1164seed)
 (:domain transport)
 (:objects
