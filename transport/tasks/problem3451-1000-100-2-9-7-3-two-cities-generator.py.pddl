; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-7trucks-9packages-3451seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-7trucks-9packages-3451seed)
 (:domain transport)
 (:objects
