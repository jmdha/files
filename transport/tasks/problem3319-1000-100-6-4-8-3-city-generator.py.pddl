; Transport city-sequential-6nodes-1000size-3degree-100mindistance-8trucks-4packages-3319seed

(define (problem transport-city-sequential-6nodes-1000size-3degree-100mindistance-8trucks-4packages-3319seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
