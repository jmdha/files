; Transport city-sequential-5nodes-1000size-3degree-100mindistance-7trucks-3packages-1512seed

(define (problem transport-city-sequential-5nodes-1000size-3degree-100mindistance-7trucks-3packages-1512seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
