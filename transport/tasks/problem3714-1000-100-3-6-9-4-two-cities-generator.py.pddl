; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-9trucks-6packages-3714seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-9trucks-6packages-3714seed)
 (:domain transport)
 (:objects
