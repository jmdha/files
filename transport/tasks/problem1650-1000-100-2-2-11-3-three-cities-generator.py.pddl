; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-11trucks-2packages-1650seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-11trucks-2packages-1650seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-3-loc-1) 245)
  (road city-3-loc-1 city-1-loc-1)
  (= (road-length city-3-loc-1 city-1-loc-1) 245)
  (road city-2-loc-1 city-3-loc-2)
  (= (road-length city-2-loc-1 city-3-loc-2) 231)
  (road city-3-loc-2 city-2-loc-1)
  (= (road-length city-3-loc-2 city-2-loc-1) 231)
