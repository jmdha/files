; Transport city-sequential-6nodes-1000size-4degree-100mindistance-3trucks-7packages-2201seed

(define (problem transport-city-sequential-6nodes-1000size-4degree-100mindistance-3trucks-7packages-2201seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
