; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-5packages-2088seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-5packages-2088seed)
 (:domain transport)
 (:objects
