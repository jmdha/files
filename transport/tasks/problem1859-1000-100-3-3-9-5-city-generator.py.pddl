; Transport city-sequential-3nodes-1000size-5degree-100mindistance-9trucks-3packages-1859seed

(define (problem transport-city-sequential-3nodes-1000size-5degree-100mindistance-9trucks-3packages-1859seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
