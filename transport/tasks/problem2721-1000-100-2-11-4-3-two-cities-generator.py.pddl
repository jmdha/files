; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-11packages-2721seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-11packages-2721seed)
 (:domain transport)
 (:objects
