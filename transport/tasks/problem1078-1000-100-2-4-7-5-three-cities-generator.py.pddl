; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-4packages-1078seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-4packages-1078seed)
 (:domain transport)
 (:objects
