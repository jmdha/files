; Transport three-cities-sequential-3nodes-1000size-4degree-100mindistance-7trucks-4packages-1339seed

(define (problem transport-three-cities-sequential-3nodes-1000size-4degree-100mindistance-7trucks-4packages-1339seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-2-loc-2 city-3-loc-3) 212)
  (road city-3-loc-3 city-2-loc-2)
  (= (road-length city-3-loc-3 city-2-loc-2) 212)
