; Transport two-cities-sequential-6nodes-1000size-4degree-100mindistance-6trucks-6packages-3681seed

(define (problem transport-two-cities-sequential-6nodes-1000size-4degree-100mindistance-6trucks-6packages-3681seed)
 (:domain transport)
 (:objects
