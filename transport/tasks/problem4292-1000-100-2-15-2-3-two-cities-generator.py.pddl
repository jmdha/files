; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-2trucks-15packages-4292seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-2trucks-15packages-4292seed)
 (:domain transport)
 (:objects
