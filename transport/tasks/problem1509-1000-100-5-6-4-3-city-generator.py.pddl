; Transport city-sequential-5nodes-1000size-3degree-100mindistance-4trucks-6packages-1509seed

(define (problem transport-city-sequential-5nodes-1000size-3degree-100mindistance-4trucks-6packages-1509seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
