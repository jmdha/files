; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-11packages-2103seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-11packages-2103seed)
 (:domain transport)
 (:objects
