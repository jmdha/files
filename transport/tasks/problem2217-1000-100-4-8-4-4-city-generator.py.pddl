; Transport city-sequential-4nodes-1000size-4degree-100mindistance-4trucks-8packages-2217seed

(define (problem transport-city-sequential-4nodes-1000size-4degree-100mindistance-4trucks-8packages-2217seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
