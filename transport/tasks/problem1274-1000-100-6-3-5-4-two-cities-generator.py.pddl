; Transport two-cities-sequential-6nodes-1000size-4degree-100mindistance-5trucks-3packages-1274seed

(define (problem transport-two-cities-sequential-6nodes-1000size-4degree-100mindistance-5trucks-3packages-1274seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-6 city-2-loc-1) 136)
  (road city-2-loc-1 city-1-loc-6)
  (= (road-length city-2-loc-1 city-1-loc-6) 136)
