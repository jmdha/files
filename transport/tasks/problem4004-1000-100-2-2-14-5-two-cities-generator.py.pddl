; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-14trucks-2packages-4004seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-14trucks-2packages-4004seed)
 (:domain transport)
 (:objects
