; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-5trucks-10packages-2722seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-5trucks-10packages-2722seed)
 (:domain transport)
 (:objects
