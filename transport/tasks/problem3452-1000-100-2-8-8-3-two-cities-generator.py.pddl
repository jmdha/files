; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-8packages-3452seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-8packages-3452seed)
 (:domain transport)
 (:objects
