; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-8trucks-6packages-2504seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-8trucks-6packages-2504seed)
 (:domain transport)
 (:objects
