; Transport city-sequential-3nodes-1000size-3degree-100mindistance-9trucks-6packages-3350seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-9trucks-6packages-3350seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
