; Transport city-sequential-6nodes-1000size-3degree-100mindistance-7trucks-5packages-3318seed

(define (problem transport-city-sequential-6nodes-1000size-3degree-100mindistance-7trucks-5packages-3318seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
