; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-11trucks-3packages-2507seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-11trucks-3packages-2507seed)
 (:domain transport)
 (:objects
