; Transport three-cities-sequential-3nodes-1000size-5degree-100mindistance-4trucks-8packages-1964seed

(define (problem transport-three-cities-sequential-3nodes-1000size-5degree-100mindistance-4trucks-8packages-1964seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-3-loc-3) 145)
  (road city-3-loc-3 city-1-loc-1)
  (= (road-length city-3-loc-3 city-1-loc-1) 145)
