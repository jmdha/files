; Transport two-cities-sequential-3nodes-1000size-3degree-100mindistance-7trucks-5packages-1582seed

(define (problem transport-two-cities-sequential-3nodes-1000size-3degree-100mindistance-7trucks-5packages-1582seed)
 (:domain transport)
 (:objects
