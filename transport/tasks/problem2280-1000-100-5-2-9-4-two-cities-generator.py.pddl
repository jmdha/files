; Transport two-cities-sequential-5nodes-1000size-4degree-100mindistance-9trucks-2packages-2280seed

(define (problem transport-two-cities-sequential-5nodes-1000size-4degree-100mindistance-9trucks-2packages-2280seed)
 (:domain transport)
 (:objects
