; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-8trucks-4packages-1748seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-8trucks-4packages-1748seed)
 (:domain transport)
 (:objects
