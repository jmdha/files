; Transport city-sequential-3nodes-1000size-5degree-100mindistance-6trucks-7packages-2426seed

(define (problem transport-city-sequential-3nodes-1000size-5degree-100mindistance-6trucks-7packages-2426seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
