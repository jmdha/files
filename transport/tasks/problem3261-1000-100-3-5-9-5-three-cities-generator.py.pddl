; Transport three-cities-sequential-3nodes-1000size-5degree-100mindistance-9trucks-5packages-3261seed

(define (problem transport-three-cities-sequential-3nodes-1000size-5degree-100mindistance-9trucks-5packages-3261seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-2-loc-2) 169)
  (road city-2-loc-2 city-1-loc-2)
  (= (road-length city-2-loc-2 city-1-loc-2) 169)
  ...
  (= (road-length city-2-loc-3 city-3-loc-2) 173)
  (road city-3-loc-2 city-2-loc-3)
  (= (road-length city-3-loc-2 city-2-loc-3) 173)
