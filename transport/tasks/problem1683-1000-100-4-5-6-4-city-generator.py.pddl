; Transport city-sequential-4nodes-1000size-4degree-100mindistance-6trucks-5packages-1683seed

(define (problem transport-city-sequential-4nodes-1000size-4degree-100mindistance-6trucks-5packages-1683seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
