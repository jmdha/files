; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-7trucks-6packages-2493seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-7trucks-6packages-2493seed)
 (:domain transport)
 (:objects
