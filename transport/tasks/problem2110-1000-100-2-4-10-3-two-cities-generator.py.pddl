; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-10trucks-4packages-2110seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-10trucks-4packages-2110seed)
 (:domain transport)
 (:objects
