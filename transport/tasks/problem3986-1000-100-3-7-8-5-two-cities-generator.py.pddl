; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-8trucks-7packages-3986seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-8trucks-7packages-3986seed)
 (:domain transport)
 (:objects
