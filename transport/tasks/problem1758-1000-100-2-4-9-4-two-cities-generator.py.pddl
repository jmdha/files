; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-9trucks-4packages-1758seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-9trucks-4packages-1758seed)
 (:domain transport)
 (:objects
