; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-12packages-2798seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-12packages-2798seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-3-loc-2) 197)
  (road city-3-loc-2 city-1-loc-1)
  (= (road-length city-3-loc-2 city-1-loc-1) 197)
  (road city-2-loc-1 city-3-loc-1)
  (= (road-length city-2-loc-1 city-3-loc-1) 219)
  (road city-3-loc-1 city-2-loc-1)
  (= (road-length city-3-loc-1 city-2-loc-1) 219)
