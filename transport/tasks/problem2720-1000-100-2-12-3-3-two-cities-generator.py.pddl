; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-12packages-2720seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-3trucks-12packages-2720seed)
 (:domain transport)
 (:objects
