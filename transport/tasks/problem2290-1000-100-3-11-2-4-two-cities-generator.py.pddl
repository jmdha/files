; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-2trucks-11packages-2290seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-2trucks-11packages-2290seed)
 (:domain transport)
 (:objects
