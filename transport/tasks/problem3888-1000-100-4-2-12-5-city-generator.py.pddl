; Transport city-sequential-4nodes-1000size-5degree-100mindistance-12trucks-2packages-3888seed

(define (problem transport-city-sequential-4nodes-1000size-5degree-100mindistance-12trucks-2packages-3888seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
 ...
 (:init
  ...
  (= (road-length city-loc-4 city-loc-3) 74)
  ; 678,747 -> 251,151
  (road city-loc-3 city-loc-4)
  (= (road-length city-loc-3 city-loc-4) 74)
