; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-10trucks-7packages-4300seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-10trucks-7packages-4300seed)
 (:domain transport)
 (:objects
