; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-6packages-1301seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-6trucks-6packages-1301seed)
 (:domain transport)
 (:objects
