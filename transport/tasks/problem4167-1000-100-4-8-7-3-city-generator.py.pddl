; Transport city-sequential-4nodes-1000size-3degree-100mindistance-7trucks-8packages-4167seed

(define (problem transport-city-sequential-4nodes-1000size-3degree-100mindistance-7trucks-8packages-4167seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
