; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-8packages-2502seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-8packages-2502seed)
 (:domain transport)
 (:objects
