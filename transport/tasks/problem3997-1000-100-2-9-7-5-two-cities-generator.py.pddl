; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-9packages-3997seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-9packages-3997seed)
 (:domain transport)
 (:objects
