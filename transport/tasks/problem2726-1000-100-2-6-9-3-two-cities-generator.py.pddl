; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-6packages-2726seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-6packages-2726seed)
 (:domain transport)
 (:objects
