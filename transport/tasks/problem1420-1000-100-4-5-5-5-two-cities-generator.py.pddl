; Transport two-cities-sequential-4nodes-1000size-5degree-100mindistance-5trucks-5packages-1420seed

(define (problem transport-two-cities-sequential-4nodes-1000size-5degree-100mindistance-5trucks-5packages-1420seed)
 (:domain transport)
 (:objects
