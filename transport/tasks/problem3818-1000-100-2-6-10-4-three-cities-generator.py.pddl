; Transport three-cities-sequential-2nodes-1000size-4degree-100mindistance-10trucks-6packages-3818seed

(define (problem transport-three-cities-sequential-2nodes-1000size-4degree-100mindistance-10trucks-6packages-3818seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-2 city-3-loc-2) 192)
  (road city-3-loc-2 city-1-loc-2)
  (= (road-length city-3-loc-2 city-1-loc-2) 192)
  (road city-2-loc-2 city-3-loc-1)
  (= (road-length city-2-loc-2 city-3-loc-1) 202)
  (road city-3-loc-1 city-2-loc-2)
  (= (road-length city-3-loc-1 city-2-loc-2) 202)
