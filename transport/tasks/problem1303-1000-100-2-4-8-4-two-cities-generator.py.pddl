; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-4packages-1303seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-4packages-1303seed)
 (:domain transport)
 (:objects
