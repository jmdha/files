; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-12trucks-4packages-3456seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-12trucks-4packages-3456seed)
 (:domain transport)
 (:objects
