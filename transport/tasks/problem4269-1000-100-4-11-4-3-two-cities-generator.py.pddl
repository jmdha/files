; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-4trucks-11packages-4269seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-4trucks-11packages-4269seed)
 (:domain transport)
 (:objects
