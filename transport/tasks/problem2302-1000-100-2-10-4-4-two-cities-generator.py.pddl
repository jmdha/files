; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-10packages-2302seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-10packages-2302seed)
 (:domain transport)
 (:objects
