; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-6trucks-9packages-3711seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-6trucks-9packages-3711seed)
 (:domain transport)
 (:objects
