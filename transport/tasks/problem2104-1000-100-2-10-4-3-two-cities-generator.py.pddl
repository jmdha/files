; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-10packages-2104seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-4trucks-10packages-2104seed)
 (:domain transport)
 (:objects
