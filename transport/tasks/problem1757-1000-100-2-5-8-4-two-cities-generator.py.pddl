; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-5packages-1757seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-5packages-1757seed)
 (:domain transport)
 (:objects
