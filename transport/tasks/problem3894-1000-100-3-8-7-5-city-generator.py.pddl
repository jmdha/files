; Transport city-sequential-3nodes-1000size-5degree-100mindistance-7trucks-8packages-3894seed

(define (problem transport-city-sequential-3nodes-1000size-5degree-100mindistance-7trucks-8packages-3894seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
