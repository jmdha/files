; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-6packages-1436seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-6trucks-6packages-1436seed)
 (:domain transport)
 (:objects
