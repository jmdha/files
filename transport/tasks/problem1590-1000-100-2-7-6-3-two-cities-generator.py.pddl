; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-7packages-1590seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-6trucks-7packages-1590seed)
 (:domain transport)
 (:objects
