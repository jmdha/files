; Transport three-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-6packages-3272seed

(define (problem transport-three-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-6packages-3272seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-1 city-3-loc-2) 211)
  (road city-3-loc-2 city-1-loc-1)
  (= (road-length city-3-loc-2 city-1-loc-1) 211)
  (road city-2-loc-2 city-3-loc-2)
  (= (road-length city-2-loc-2 city-3-loc-2) 180)
  (road city-3-loc-2 city-2-loc-2)
  (= (road-length city-3-loc-2 city-2-loc-2) 180)
