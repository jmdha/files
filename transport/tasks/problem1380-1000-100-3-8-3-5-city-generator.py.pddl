; Transport city-sequential-3nodes-1000size-5degree-100mindistance-3trucks-8packages-1380seed

(define (problem transport-city-sequential-3nodes-1000size-5degree-100mindistance-3trucks-8packages-1380seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
