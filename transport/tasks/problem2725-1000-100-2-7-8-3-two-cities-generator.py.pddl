; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-7packages-2725seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-8trucks-7packages-2725seed)
 (:domain transport)
 (:objects
