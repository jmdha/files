; Transport city-sequential-5nodes-1000size-4degree-100mindistance-8trucks-2packages-1678seed

(define (problem transport-city-sequential-5nodes-1000size-4degree-100mindistance-8trucks-2packages-1678seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
