; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-8trucks-5packages-2494seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-8trucks-5packages-2494seed)
 (:domain transport)
 (:objects
