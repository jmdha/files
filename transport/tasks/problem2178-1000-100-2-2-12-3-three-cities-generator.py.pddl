; Transport three-cities-sequential-2nodes-1000size-3degree-100mindistance-12trucks-2packages-2178seed

(define (problem transport-three-cities-sequential-2nodes-1000size-3degree-100mindistance-12trucks-2packages-2178seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-2-loc-1 city-3-loc-1) 215)
  (road city-3-loc-1 city-2-loc-1)
  (= (road-length city-3-loc-1 city-2-loc-1) 215)
