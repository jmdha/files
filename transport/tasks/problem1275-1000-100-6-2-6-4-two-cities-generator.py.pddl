; Transport two-cities-sequential-6nodes-1000size-4degree-100mindistance-6trucks-2packages-1275seed

(define (problem transport-two-cities-sequential-6nodes-1000size-4degree-100mindistance-6trucks-2packages-1275seed)
 (:domain transport)
 (:objects
