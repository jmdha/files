; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-2trucks-9packages-1289seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-2trucks-9packages-1289seed)
 (:domain transport)
 (:objects
