; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-8trucks-4packages-1438seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-8trucks-4packages-1438seed)
 (:domain transport)
 (:objects
