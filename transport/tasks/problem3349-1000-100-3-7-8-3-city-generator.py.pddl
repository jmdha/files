; Transport city-sequential-3nodes-1000size-3degree-100mindistance-8trucks-7packages-3349seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-8trucks-7packages-3349seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
