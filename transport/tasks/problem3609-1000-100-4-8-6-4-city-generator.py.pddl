; Transport city-sequential-4nodes-1000size-4degree-100mindistance-6trucks-8packages-3609seed

(define (problem transport-city-sequential-4nodes-1000size-4degree-100mindistance-6trucks-8packages-3609seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
