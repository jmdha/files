; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-8packages-1754seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-5trucks-8packages-1754seed)
 (:domain transport)
 (:objects
