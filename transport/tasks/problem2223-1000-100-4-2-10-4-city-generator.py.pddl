; Transport city-sequential-4nodes-1000size-4degree-100mindistance-10trucks-2packages-2223seed

(define (problem transport-city-sequential-4nodes-1000size-4degree-100mindistance-10trucks-2packages-2223seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
