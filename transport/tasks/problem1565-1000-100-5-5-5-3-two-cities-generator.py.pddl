; Transport two-cities-sequential-5nodes-1000size-3degree-100mindistance-5trucks-5packages-1565seed

(define (problem transport-two-cities-sequential-5nodes-1000size-3degree-100mindistance-5trucks-5packages-1565seed)
 (:domain transport)
 (:objects
