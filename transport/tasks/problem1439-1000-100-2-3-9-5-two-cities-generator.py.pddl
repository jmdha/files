; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-3packages-1439seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-3packages-1439seed)
 (:domain transport)
 (:objects
