; Transport three-cities-sequential-7nodes-1000size-3degree-100mindistance-6trucks-2packages-1610seed

(define (problem transport-three-cities-sequential-7nodes-1000size-3degree-100mindistance-6trucks-2packages-1610seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-4 city-2-loc-6) 112)
  (road city-2-loc-6 city-1-loc-4)
  (= (road-length city-2-loc-6 city-1-loc-4) 112)
  ...
  (= (road-length city-2-loc-2 city-3-loc-6) 144)
  (road city-3-loc-6 city-2-loc-2)
  (= (road-length city-3-loc-6 city-2-loc-2) 144)
