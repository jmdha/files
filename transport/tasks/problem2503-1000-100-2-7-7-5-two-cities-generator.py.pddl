; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-7packages-2503seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-7packages-2503seed)
 (:domain transport)
 (:objects
