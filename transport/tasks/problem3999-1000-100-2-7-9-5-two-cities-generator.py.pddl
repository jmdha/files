; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-7packages-3999seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-9trucks-7packages-3999seed)
 (:domain transport)
 (:objects
