; Transport city-sequential-4nodes-1000size-4degree-100mindistance-2trucks-9packages-1679seed

(define (problem transport-city-sequential-4nodes-1000size-4degree-100mindistance-2trucks-9packages-1679seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
