; Transport two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-7packages-3428seed

(define (problem transport-two-cities-sequential-4nodes-1000size-3degree-100mindistance-7trucks-7packages-3428seed)
 (:domain transport)
 (:objects
