; Transport city-sequential-3nodes-1000size-3degree-100mindistance-9trucks-5packages-2637seed

(define (problem transport-city-sequential-3nodes-1000size-3degree-100mindistance-9trucks-5packages-2637seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
