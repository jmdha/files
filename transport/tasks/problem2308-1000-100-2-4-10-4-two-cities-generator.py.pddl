; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-10trucks-4packages-2308seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-10trucks-4packages-2308seed)
 (:domain transport)
 (:objects
