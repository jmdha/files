; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-10trucks-4packages-2506seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-10trucks-4packages-2506seed)
 (:domain transport)
 (:objects
