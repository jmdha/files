; Transport two-cities-sequential-3nodes-1000size-4degree-100mindistance-4trucks-8packages-1744seed

(define (problem transport-two-cities-sequential-3nodes-1000size-4degree-100mindistance-4trucks-8packages-1744seed)
 (:domain transport)
 (:objects
