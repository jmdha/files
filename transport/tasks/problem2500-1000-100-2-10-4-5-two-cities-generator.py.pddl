; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-10packages-2500seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-4trucks-10packages-2500seed)
 (:domain transport)
 (:objects
