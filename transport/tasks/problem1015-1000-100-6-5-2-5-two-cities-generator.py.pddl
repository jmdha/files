; Transport two-cities-sequential-6nodes-1000size-5degree-100mindistance-2trucks-5packages-1015seed

(define (problem transport-two-cities-sequential-6nodes-1000size-5degree-100mindistance-2trucks-5packages-1015seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-1-loc-3 city-2-loc-6) 113)
  (road city-2-loc-6 city-1-loc-3)
  (= (road-length city-2-loc-6 city-1-loc-3) 113)
