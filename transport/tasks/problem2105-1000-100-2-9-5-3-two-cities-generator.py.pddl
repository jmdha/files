; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-5trucks-9packages-2105seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-5trucks-9packages-2105seed)
 (:domain transport)
 (:objects
