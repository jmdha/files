; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-9packages-1753seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-4trucks-9packages-1753seed)
 (:domain transport)
 (:objects
