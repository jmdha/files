; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-7packages-3453seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-9trucks-7packages-3453seed)
 (:domain transport)
 (:objects
