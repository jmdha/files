; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-8trucks-7packages-3193seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-8trucks-7packages-3193seed)
 (:domain transport)
 (:objects
