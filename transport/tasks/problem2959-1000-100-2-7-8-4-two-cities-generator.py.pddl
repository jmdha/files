; Transport two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-7packages-2959seed

(define (problem transport-two-cities-sequential-2nodes-1000size-4degree-100mindistance-8trucks-7packages-2959seed)
 (:domain transport)
 (:objects
