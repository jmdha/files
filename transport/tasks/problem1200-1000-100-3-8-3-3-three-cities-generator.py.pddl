; Transport three-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-8packages-1200seed

(define (problem transport-three-cities-sequential-3nodes-1000size-3degree-100mindistance-3trucks-8packages-1200seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (= (road-length city-2-loc-2 city-3-loc-3) 204)
  (road city-3-loc-3 city-2-loc-2)
  (= (road-length city-3-loc-3 city-2-loc-2) 204)
