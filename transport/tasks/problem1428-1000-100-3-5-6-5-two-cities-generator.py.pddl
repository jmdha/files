; Transport two-cities-sequential-3nodes-1000size-5degree-100mindistance-6trucks-5packages-1428seed

(define (problem transport-two-cities-sequential-3nodes-1000size-5degree-100mindistance-6trucks-5packages-1428seed)
 (:domain transport)
 (:objects
