; Transport two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-5packages-1437seed

(define (problem transport-two-cities-sequential-2nodes-1000size-5degree-100mindistance-7trucks-5packages-1437seed)
 (:domain transport)
 (:objects
