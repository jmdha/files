; Transport two-cities-sequential-5nodes-1000size-3degree-100mindistance-4trucks-6packages-1564seed

(define (problem transport-two-cities-sequential-5nodes-1000size-3degree-100mindistance-4trucks-6packages-1564seed)
 (:domain transport)
 (:objects
