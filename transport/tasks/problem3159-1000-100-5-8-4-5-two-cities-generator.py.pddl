; Transport two-cities-sequential-5nodes-1000size-5degree-100mindistance-4trucks-8packages-3159seed

(define (problem transport-two-cities-sequential-5nodes-1000size-5degree-100mindistance-4trucks-8packages-3159seed)
 (:domain transport)
 (:objects
