; Transport two-cities-sequential-2nodes-1000size-3degree-100mindistance-7trucks-8packages-2724seed

(define (problem transport-two-cities-sequential-2nodes-1000size-3degree-100mindistance-7trucks-8packages-2724seed)
 (:domain transport)
 (:objects
